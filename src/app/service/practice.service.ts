...
export class PracticeService {
  ...
  createUser(payLoad: User) {
    return this.http.post<User>(`api/user`, payLoad).pipe(
      tap((user) => {
  ...
  updateUser(payLoad: User) {
    return this.http.put<User>(`api/user/${payLoad.id}`, payLoad).pipe(
      tap((user) => {
  ...
  deleteUser(payLoad: User) {
    return this.http.delete<User>(`api/user/${payLoad.id}`).pipe(
      tap(() => {
